...
const (
	...
	pallocChunkPages    = 1 << logPallocChunkPages	//0x200
	pallocChunkBytes    = pallocChunkPages * pageSize	//4194304
	...
	pallocChunksL2Bits  = heapAddrBits - logPallocChunkBytes - pallocChunksL1Bits	//13
...
var maxSearchAddr = maxOffAddr	//0x7fffffffffff
...
func (i chunkIdx) l1() uint {
	if pallocChunksL1Bits == 0 {
		...
		return uint(i) >> pallocChunksL1Shift	//pallocChunksL1Shift = 13
	}
}
...
func (i chunkIdx) l2() uint {
	if pallocChunksL1Bits == 0 {
		...
		return uint(i) & (1<<pallocChunksL2Bits - 1)	//i & 0x1fff
	}
}
...
const (
	...
	maxPackedValue    = 1 << logMaxPackedValue	//0x200000
