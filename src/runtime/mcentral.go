...
type mcentral struct {
	...
	nonempty mSpanList // list of spans with a free object, ie a nonempty free list		// non-empty 指还有空闲块的span列表
	empty    mSpanList // list of spans with no free objects (or cached in an mcache)	// 指没有空闲块的span列表
